...
def label_PASSPHRASE(s):
  print var_value(s, KLAETU)
  print get_value(s, ARG2)
  print get_value(s, PASSWORD)
  if  ((((((((((((((( NEARP(s,SAFE) ))))))))))))))) :
    if  ((((((((((((((( EQP(s,SAFE,0) ))))))))))))))) :
      if  ((((((((((((((( EQP(s,ARG2,PASSWORD)  or  EQP(s,ARG1,PASSWORD) ) )))))))))))))) :
        opSAY(s,SAFE_OPENS)
        opSET(s,SAFE,1)
        BIS(s,SAFE,SPECIAL1)
        opQUIT(s)
...
def at_func_ICECAVE_22(s):
  MOVE(s,SE,ICECAVE_18)
  MOVE(s,NW,ICECAVE_23)
...
def action_CAVE_3(s):
  ...
  opSAY(s,WHEREISCAVE)
  opQUIT(s)
CAVE_3 = mkACTION('CAVE', action_CAVE_3)

def action_CAVE_4(s):
  AT(s,STREAM)
  opSAY(s,WHEREISCAVE)
  opQUIT(s)
CAVE_4 = mkACTION('CAVE', action_CAVE_4)

def action_CAVE_5(s):
  AT(s,ROAD)
  opSAY(s,WHEREISCAVE)
  opQUIT(s)
CAVE_5 = mkACTION('CAVE', action_CAVE_5)

def action_CAVE_6(s):
  AT(s,SLIT)
  opSAY(s,WHEREISCAVE)
  opQUIT(s)
CAVE_6 = mkACTION('CAVE', action_CAVE_6)

def action_CAVE_7(s):
  AT(s,DEPRESSION)
  opSAY(s,WHEREISCAVE)
  opQUIT(s)
CAVE_7 = mkACTION('CAVE', action_CAVE_7)

def action_CAVE_8(s):
  AT(s,BUILDING)
  opSAY(s,WHEREISCAVE)
  opQUIT(s)
CAVE_8 = mkACTION('CAVE', action_CAVE_8)

def action_CAVE_9(s):
  opSAY(s,NEEDDETAIL)
  opQUIT(s)
CAVE_9 = mkACTION('CAVE', action_CAVE_9)
